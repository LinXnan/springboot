...
import com.example.websocket.configation.WebSocketUserAuthentication;
 ...
 * @date 2020-03-27 下午 04:57
 */
@Controller
public class WebSocketStompController {

    Logger log = LoggerFactory.getLogger(WebSocketStompController.class);
